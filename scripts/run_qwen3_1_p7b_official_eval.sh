...
# VAL_FILES="['${AIME24_VAL_FILE}']"
VAL_FILES="['${VAL_FILE}','${AIME24_VAL_FILE}','${HMMT25_VAL_FILE}']"
...
OPSD_RUBRIC_ENABLED=${OPSD_RUBRIC_ENABLED:-False}
OPSD_DYNAMIC_RUBRIC_ENABLED=${OPSD_DYNAMIC_RUBRIC_ENABLED:-False}
...
EXP_NAME="${MODEL_TAG}_forwardkl_baseline_${LOSS_TAG}_official_eval_bs${TRAIN_PROMPT_BSZ}_mb${STUDENT_MICRO_BATCH_SIZE_PER_GPU}_ws${STUDENT_WORLD_SIZE}_seq${ROLLOUT_MAX_NUM_SEQS}_${RUN_TIMESTAMP}"
