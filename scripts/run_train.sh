...
EXP_NAME="${MODEL_TAG}_${DISTILLATION_LOSS_MODE}_${DISTILLATION_TOPK}_${USE_POLICY_GRADIENT}_${DISTILLATION_TOPK}_baseline_${LOSS_TAG}_official_eval_bs${TRAIN_PROMPT_BSZ}_mb${STUDENT_MICRO_BATCH_SIZE_PER_GPU}_ws${STUDENT_WORLD_SIZE}_seq${ROLLOUT_MAX_NUM_SEQS}_${RUN_TIMESTAMP}"
